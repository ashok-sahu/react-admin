        ...
        <div className="row mb-2">
          ...
          <div className="col-sm-6">
            <ol className="breadcrumb float-sm-right">
              <li className="breadcrumb-item"><a href='alt'>Home</a></li>
        ...
        <div className="row">
          <div className="col-lg-3 col-6">
            ...
            <div className="small-box bg-info">
              ...
              <a href='alt' className="small-box-footer">More info <i className="fas fa-arrow-circle-right" /></a>
            </div>
          </div>
          {/* ./col */}
          <div className="col-lg-3 col-6">
              ...
              <div className="card-header">
                ...
                <div className="card-tools">
                  <ul className="pagination pagination-sm">
                    <li className="page-item"><a href='alt' className="page-link">«</a></li>
                    <li className="page-item"><a href='alt' className="page-link">1</a></li>
                    <li className="page-item"><a href='alt' className="page-link">2</a></li>
                    <li className="page-item"><a href='alt' className="page-link">3</a></li>
                    <li className="page-item"><a href='alt' className="page-link">»</a></li>
                  </ul>
                </div>
              </div>
                ...
                <div className="card-tools">
                  ...
                  <div className="btn-group">
                    ...
                    <div className="dropdown-menu float-right" role="menu">
                      <a href='alt' className="dropdown-item">Add new event</a>
                      <a href='alt' className="dropdown-item">Clear events</a>
                      <div className="dropdown-divider" />
                      <a href='alt' className="dropdown-item">View calendar</a>
                    </div>
                  </div>
